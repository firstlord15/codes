...
urlpatterns = [
    ...
    re_path('borrowed/', views.LoanedBooksAllListView.as_view(), name='all-borrowed'),
]
...
urlpatterns += [
    re_path(r'^borrowed-books/', views.BorrowedBooksListView.as_view(), name='borrowed-books'),
]
