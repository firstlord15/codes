...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        BankAccount My = new BankAccount("Ратмир", "Ашимов", "1", "79096895085", 0, "$", accountArrayList);
        accountArrayList.add(My);

        BankAccount MyF = new BankAccount("Салим", "Алиев", "2", "79096895085", 0, "$", accountArrayList);
        accountArrayList.add(MyF);

        BankAccount MyF2 = new BankAccount("Огабек", "Амиров", "3", "79096895085", 0, "$", accountArrayList);
